...
If you complete the [Setup Steps](#setup-steps) below and the _AddressFinder_ service is not auto-suggesting addresses as it should, please refer to the [Troubleshooting](https://github.com/AbleTech/addressfinder-salesforce-lightning/wiki/Troubleshooting) section.
